            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8 border-t border-gray-700 pt-8">
                    <div>
                        ...
                        <p className="text-sm opacity-90 mb-2">Gading Serpong, Tangerang</p>
                        <p className="text-sm opacity-90">+62 21 3950 3000</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-sm opacity-90 mb-4">{t.footer.subscribe}</p>
                        <div className="flex">
                            <input
                                type="email"
                ...
                <div className="text-center text-xs opacity-80 pt-8 border-t border-gray-800 space-y-2">
                    <p>© {new Date().getFullYear()} JHL Solitaire Gading Serpong. {t.footer.rights}</p>
                    <div className="text-[10px] tracking-widest uppercase font-bold text-red-100 mt-4 border border-red-500/30 inline-block px-4 py-2 rounded bg-red-900/50">
